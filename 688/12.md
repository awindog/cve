...
TOTOLINK EX1200T V4.1.2cu.5232_B20210713 router has a serious buffer overflow vulnerability. This vulnerability can be triggered through the route /boafrm/formTmultiAP. An attacker can implement a denial of service attack by sending a malicious HTTP POST request.
...
![image-20250608175706254](12/image-20250608175706254.png)

There is a buffer overflow here

![image-20250608175726187](12/image-20250608175726187.png)
...
![image-20250608175758227](12/image-20250608175758227.png)