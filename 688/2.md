...
TOTOLINK EX1200T V4.1.2cu.5232_B20210713 router has a serious buffer overflow vulnerability. This vulnerability can be triggered through the route /boafrm/formSysLog. An attacker can implement a denial of service attack by sending a malicious HTTP POST request.
...
![image-20250608153707098](2/image-20250608153707098.png)



There is a buffer overflow here

![image-20250608153801482](2/image-20250608153801482.png)
...
![image-20250509213955866](2/image-20250509213955866.png)